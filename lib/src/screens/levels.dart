                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 29, 27, 27).withOpacity(0.9), // Background color
                        borderRadius: BorderRadius.circular(8.0),
                      ),
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                            color: Colors.white.withOpacity(0.6), // Adjust label text color as needed
                          ),
                        ...
                        cursorColor: Colors.blue, // Adjust cursor color as needed
                      ),
                    ),
                  ],
                ),
...
void main() => runApp(MaterialApp(home: LevelsPage()));
